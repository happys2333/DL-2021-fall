...
#         return x2
    def forward(self, value, key, query, t):
        x1 = self.dropout( self.norm2(self.TTransformer(value, key, query, t) + query)) 
        x2 = self.norm1(self.STransformer(x1, x1, x1) + x1)
        return x2
