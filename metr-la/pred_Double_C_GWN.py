...
from model.GraphWaveNet import *
import Metrics
...
def getModel(name):
    ...
    ### Construct Network
    model = gwnet(device, num_nodes=N_NODE, in_dim=in_channels, supports=supports).to(device)
    return model
...
################# Parameter Setting #######################
MODELNAME = 'Double-C-STTN-oringal'
...
def main():
    ...
    shutil.copy2('model/STTN_oringal.py', PATH)
