...
class SMultiHeadAttention(nn.Module):
    def __init__(self,k, embed_size, heads):
...
class STransformer(nn.Module):
    def __init__(self, embed_size, heads, adj, cheb_K, dropout, forward_expansion):
        ...
        self.attention = SMultiHeadAttention(cheb_K,embed_size, heads)
...
def main():
    ...
    summary(model, (1, N_NODE, TIMESTEP_IN), device=device)
    print_params('STTNConv', model)
